...
The **Friend** keyword can only be used in class modules. However, **Friend** procedures can be accessed by procedures in any module of a project. A **Friend** procedure does't appear in the [type library](vbe-glossary.md) of its parent class, nor can a **Friend** procedure be late bound.
...
You call a **Function** procedure using the function name, followed by the argument list in parentheses, in an expression. See the [**Call**](https://msdn.microsoft.com/en-us/vba/language-reference-vba/articles/calling-sub-and-function-procedures) statement for specific information on how to call **Function** procedures.
...
Variables used in **Function** procedures fall into two categories: 
 - those that are explicitly declared within the procedure, and 
 - those that are not.
